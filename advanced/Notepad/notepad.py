...
red_icon = tk.PhotoImage(file='icons2/dracula.png')
...
view.add_checkbutton(label='Staus Bar', onvalue=1, offvalue=False, variable=show_statusbar, image=status_bar_icon,
